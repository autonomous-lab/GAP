#!/usr/bin/env python3
"""Manage live Compose approvals on the operator host without restarting GAP."""
import argparse
import fcntl
import json
import os
...
def main():
    ...
    parser.add_argument('--file', default='data/gap-node/compose-agents.json', help='host path matching GAP_COMPOSE_APPROVALS_FILE')
