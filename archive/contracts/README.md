...
Historical documentation; the contract APIs are no longer served by GAP Cloud.
Relative links below refer to the original repository root. Browse the complete
[pre-pivot snapshot](https://github.com/autonomous-lab/GAP/tree/20a015e) for those files.
For the active product, read [GAP Cloud](../../README.md).
