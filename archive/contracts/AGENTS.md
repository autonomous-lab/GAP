# Archived instructions — do not use with GAP Cloud

These historical instructions describe the retired commerce API. Relative links
refer to the original repository root. Current instructions: [AGENTS.md](../../AGENTS.md).
