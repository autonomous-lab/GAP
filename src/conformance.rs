...
impl Level {
    ...
    pub fn required_areas(&self) -> &'static [&'static str] {
        match self {
            ...
            Level::L2 => &["identity", "message", "discovery", "agentcard", "contract", "execution"],
            Level::L3 => &[
                "identity", "message", "discovery", "agentcard", "contract", "execution",
                "payment", "governance", "policy",
            ],
            Level::L4 => &[
                "identity", "message", "discovery", "agentcard", "contract", "execution",
                "payment", "governance", "policy", "delegation", "compliance",
                "receipt_chain", "tokenomics",
            ],
        }
    }
}
...
mod tests {
    ...
    fn report_signs_and_verifies() {
        ...
        let report = ConformanceReport {
            ...
            per_area: vec![
                AreaResult { area: "identity".into(), tests_run: 10, tests_passed: 10 },
                AreaResult { area: "payment".into(), tests_run: 15, tests_passed: 15 },
            ],
